...
Future<void> main() async {
  ...
  group(
    'Test ScreenMixin.copyToClipboard',
    () {
      ...
      testWidgets(
        ...
        (tester) async {
          ...
          final WithScreenMixin withScreenMixin = WithScreenMixin();
            ...
            MaterialApp(
              home: Scaffold(
                ...
                body: TextField(
                  ...
                  onTap: () async {
                    await withScreenMixin.copyToClipboard(
          ...
          final Finder firstTimeTextFieldFinder = find.byKey(tapTarget);
          ...
          expect(firstTimeTextFieldController.text, '$percentValue %');
