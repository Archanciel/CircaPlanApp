    ...
    () {
      testWidgets(
        ...
        (tester) async {
          ...
          expect(
            ...
            ScreenMixin
                .DURATION_POSITIVE_COLOR, // duration icon color now positive
          );

          expect(
            thirdDurationDateTimeEditorWidget.durationTextColor,
            ScreenMixin
                .DURATION_POSITIVE_COLOR, // duration text color now positive
          );
      ...
      testWidgets(
        ...
        (tester) async {
          ...
          // 4 hours sooner than 12-07-2022 13:50
          ...
          expect(
            thirdDurationDateTimeEditorWidget.durationStr,
            '5:00', // duration 4 hours smaller: -1:00 - 4:00 = -5:00 !
          );
          ...
          expect(
            thirdDurationDateTimeEditorWidget.durationIcon,
            Icons.remove, // duration icon now add
          );

          expect(
            thirdDurationDateTimeEditorWidget.durationIconColor,
            ScreenMixin
                .DURATION_NEGATIVE_COLOR, // duration icon color now positive
          );

          expect(
            thirdDurationDateTimeEditorWidget.durationTextColor,
            ScreenMixin
                .DURATION_NEGATIVE_COLOR, // duration text color now positive
          );
